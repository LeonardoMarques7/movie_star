...
<div class="card movie-card">
    ...
    <div class="card-body">
        ...
        <h3 class="card-title"><a href="<?= $BASE_URL ?>movie.php?id=<?= $movie->id ?>"><?= $movie->title ?></a></h3>
        <a href="<?= $BASE_URL ?>movie.php?id=<?= $movie->id ?>" class="btn btn-primary rate-btn">Avaliar</a>
        <a href="<?= $BASE_URL ?>movie.php?id=<?= $movie->id ?>" class="btn btn-warnig card-btn">Conhecer</a>
    </div>
</div>